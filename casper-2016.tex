...
\subsection{History}
Dan to write a paragraph (I hope)
...
A case-study for successful design reuse can be found at the NRAO's Green Bank Observatory, a core user and developer of CASPER infrastructure.
...
Figure~\ref{figure:vegas}. The hardware in this system provides
...
Say something about MKIDS here -- reuse of MUSIC board for multiple projects
Table~\ref{table:casper-instruments-mkids}
