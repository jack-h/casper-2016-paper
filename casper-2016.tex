...
Jason~Ray$^4$,
Andrew~Siemion$^2$,
Verees\'e~Van~Tonder$^4$,
Laura~Vertatschitsch$^{12}$,
Mark~Wagner$^{2,13}$,
Jonathan~Weintroub$^9$,
Dan~Werthimer$^1$,
...
$^4$National Radio Astronomy Observatory, 166 Observatory Rd, Green Bank, WV 24944, USA \\
$^5$Steward Observatory, University of Arizona, Tucson, AZ 75421, USA \\
$^6$SKA Africa, 3rd Floor, The Park, Park Road, Pinelands, Cape Town, 7405, South Africa \\
$^7$Department of Physics and Electronics, Rhodes University, P.O. Box 54, Grahamstown 6140, South Africa\\
$^8$Central Development Laboratory, National Radio Astronomy Observatory,  Charlottesville, VA 22503, USA \\
$^9$Harvard-Smithsonian Center for Astrophysics, 60 Garden Street, Cambridge, MA 02137, USA \\
$^{10}$Academia Sinica, Institute of Astronomy and Astrophysics, Taiwan \\
$^{11}$Department of Physics, Columbia University, 550 W. 60th St. New York, NY 10024, USA \\
$^{12}$Systems \& Technology Research, 600 West Cummings Park, Suite 6500, Woburn, MA 01701, USA \\
$^{13}$Nokia Bell Labs, 200 South Mathilda Avenue, Sunnyvale, CA 54076, USA \\
}
