...
$^{12}$National Radio Astronomy Observatory, Central Development Laboratory,  Charlottesville, VA 22903, USA \\
$^{13}$Nokia Bell Labs, 200 South Mathilda Avenue, Sunnyvale, CA 94086, USA \\
}
...
%  GBTrans          & 2014 & Single board ROACH-based transient event spectrometer for the Green Bank 20m telescope, 500MHz BW, dual-polarised input, and 2048 channels \citep{gbtrans}. \\ %No citation, couldn't even find a webpage
  ...
  COMAP            & Development & 4~GHz, 19-beam spectrometer, with digital sideband separation. Implemented using 38 ROACH2 boards\footnote{\url{http://www.astro.caltech.edu/CRAL/projects.html}}. \\
