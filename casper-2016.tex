...
%\begin{tabularx}
  ...
  VEGAS & 2014 & 8xROACH2, 16xADC5G, 16xSFP+ & Spectrometer for the GBT, 10GHz BW for one dual-polarized input or 1.25GHz BW for eight dual-polarized inputs. Wideband modes and narrowband modes, eight digitally tuned sub-bands within the 1.25GHz BW. Digitization and channelization in wideband modes. Digitization and sub-banding in narrow band modes. & cite \\
  Skynet Spectrometer & 2012 & hardware & description & cite \\
  GUPPI & 2009/2008 & hardware & description & cite \\
  Mustang & 2006 & hardware & description & cite \\
  FLAG Beamformer & Under construction & 5xROACH2, 5xSFP+ & 19 dual-polarized PAF system with 150MHz instantaneous bandwidth & cite \\
  \end{longtable}
%\end{longtable}
\end{landscape}
